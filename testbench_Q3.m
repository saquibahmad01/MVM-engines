...
load_system('Q3/From Workspace');
list = get_param('Q3/From Workspace','ObjectParameters')
...
hdlsetuptoolpath('ToolName', 'Xilinx Vivado', 'ToolPath', '/usr/local/Xilinx-2017.2/vivado_2017.2/Vivado/2017.2/bin');
