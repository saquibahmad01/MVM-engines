...
interleaving_factor = 4; % enter the interleaving factor 

feedforward_latency = 4; % enter the feedforward latency of your design

iteration_bound = dimension; % enter the iteration bound of the algorithm (number of accumulations needed)

system_latency = 1 + (iteration_bound*4); % caculate the system latency of your design based on the loop latency, iteration bound, and feedforward latency
...
load_system('Q1/From Workspace');
list = get_param('Q1/From Workspace','ObjectParameters')
